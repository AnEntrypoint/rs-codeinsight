...
pub fn get_language(ext: &str) -> Option<LangDef> {
    match ext {
        ...
        #[cfg(feature = "toml")]
        ".toml" => Some(LangDef { name: "TOML", language: tree_sitter_toml::language() }),
        #[cfg(feature = "markdown")]
        ".md" | ".markdown" => Some(LangDef { name: "Markdown", language: tree_sitter_md::LANGUAGE.into() }),
        #[cfg(feature = "kotlin")]
        ".kt" | ".kts" => Some(LangDef { name: "Kotlin", language: tree_sitter_kotlin::language() }),
        #[cfg(feature = "scala")]
        ...
        #[cfg(feature = "make")]
        ".mk" => Some(LangDef { name: "Make", language: tree_sitter_make::language() }),
        #[cfg(feature = "sql")]
        ".sql" => Some(LangDef { name: "SQL", language: tree_sitter_sql::language() }),
        #[cfg(feature = "graphql")]
        ".graphql" | ".gql" => Some(LangDef { name: "GraphQL", language: tree_sitter_graphql::language() }),
        #[cfg(feature = "dockerfile")]
        ".dockerfile" => Some(LangDef { name: "Dockerfile", language: tree_sitter_dockerfile::language() }),
        #[cfg(feature = "nix")]
        ".nix" => Some(LangDef { name: "Nix", language: tree_sitter_nix::language() }),
        #[cfg(feature = "vue")]
        ".vue" => Some(LangDef { name: "Vue", language: tree_sitter_vue::language() }),
        #[cfg(feature = "svelte")]
        ".svelte" => Some(LangDef { name: "Svelte", language: tree_sitter_svelte::LANGUAGE.into() }),
        #[cfg(feature = "r")]
        ...
        #[cfg(feature = "dart")]
        ".dart" => Some(LangDef { name: "Dart", language: tree_sitter_dart::language() }),
        #[cfg(feature = "swift")]
